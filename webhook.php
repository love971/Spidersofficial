...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢  Upgrade your power and duration as you earn more Spiders.
            🟢 Complete daily tasks and invite friends to boost your earnings!

            

        // If there was a referrer, include their ID in the link
        $referralLink = $referrer_id ? "https://v2.Spiders.com/?ref=$referrer_id" : "https://v2.Spiders.com";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play Spiders Now', 'web_app' => ['url' => $referralLink]],
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/Spidershousebot/Spiders']]
                    ]
                ])
            ];
